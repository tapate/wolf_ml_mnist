...
public class MLPMoon {
    public static void main(String[] args) throws IOException, InterruptedException {
        ...
        String trainPath = new ClassPathResource("/classification/moon_data_train.csv").getFile().getPath();
        String testPath = new ClassPathResource("/classification/moon_data_eval.csv").getFile().getPath();
